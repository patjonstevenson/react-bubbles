...
A token is used in authentication to verify that a user has logged in. Tokens are stored in local storage.

- [ ] What steps can you take in your web apps to keep your data secure?

Make sensitive routes into private routes and use a utility like axiosWithAuth to require a token to make requests.

- [ ] Describe how web servers work.

They include an API that tells the server how to handle HTTP requests - what to do with the payload and how to respond.
